...
public class ParamArray extends ParamBase {
  ...
  public static ParamArray required(String name, ParamBase childrens) {
    return new ParamArray(name, true, null, childrens);
  }
  ...
  public static ParamArray of(String name, String description, ParamBase childrens) {
